package com.nosqlbattle.widget;
...
/** Hacked together barchart view for this demo. Please do not take this as an
...
public class BarChart extends View {
  ...
  public static class Column {
    ...
    public float getMedianTiming() {
      int timingSize = timings.size();
      return timingSize > 0 ? timings.get(timingSize / 2) : 0;
    }
